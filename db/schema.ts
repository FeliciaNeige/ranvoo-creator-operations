...
export const mailSyncState = sqliteTable("mail_sync_state", {
  ...
  folderIndex: integer("folder_index").notNull().default(0),
  folderId: text("folder_id"),
  folderName: text("folder_name"),
  foldersTotal: integer("folders_total").notNull().default(0),
  foldersCompleted: integer("folders_completed").notNull().default(0),
